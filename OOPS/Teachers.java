...
public class Teachers {
    ...
    public Teachers(){
    // just to solve the problem ocur on creating "Teachers" objct co'z we created a parametrize constructr [due to this default constructor disabled.]
    }


    /*agr hum numberOfTeachers ko static ke sath-sath private v kr dete like this:- private static int numberOfTeachers;  toh uske getter check below:
     also agr hum static function nhi banaege toh toh function object ke through access hoga, the momenet we make any function static --> 
     that function will be able to access through class. */
