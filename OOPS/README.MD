...
-> In Java, this is very simple: it always points to the current object (the class instance), especially in constructors to distinguish between a parameter and a class variable.
