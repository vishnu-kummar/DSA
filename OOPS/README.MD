...
--> jb chize i.e attributes private ho aur hum chahte hai ki atleast access kr sake , kyuki private ko hum na change kr skte hai na hi access kr sakte hai,
     not even print.
--> jb hum ye chahte hai ki koi attribute private toh ho but atleast acces ho sake us case me getter function banate hai, aur hum chahte hai ki attrivutr
    ko change v kr sake toh setter banate hai.     
...
eg: jaise schoolname hai agr hamne student class me schoolname = "dps" kr diya toh titne v object banenge waha pr schoolname ki value dps hi hogi,
...
--> pr aisa krne se kbhi v value 1 se jyada nhi badegi desping of creating mutiple objects kyuki "numberOfTeacher" ekk attribute hai new object bante hi
    wo ek space legi aur us space ki value 1 hi jaegi.
--> so what we wnat is --> we don't want ki yeh individuLLAY saare objevvt me numberofteacher block bane, bus ek single block ban jaye aur khud
